...
public class Aggressive extends PlayerBehaviour {
    ...
    public void reinforcementPhase(ObservableList<Country> countryList, Country country, Player currentPlayer) {
        ...
        if (!sortedList.isEmpty()) {
            Country strongestCountry = findStrongestCountryForReinforcement(sortedList);
            if (strongestCountry != null) {
                strongestCountry.setNoOfArmies(strongestCountry.getNoOfArmies() + currentPlayer.getArmyCount());
                System.out.println(currentPlayer.getName() + " aggressive player has been assigned all the " + currentPlayer.getArmyCount()
                        + " armies to the strongest country " + strongestCountry.getName() + " , army count " + strongestCountry.getNoOfArmies());
                setChanged();
