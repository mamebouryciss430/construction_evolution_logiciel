...
public class PlayerTest {
	...
	public void isAttackMoveValidTest() {
        ...
        ValidationResult result = player1.isAttackMoveValid(attackingCountry, defendingCountry);
	...
	public void checkPlayerLostTest()  {
        ...
        assertEquals(player2.getName(),
                PlayerVictoryManager.playersWhoLost(players, player1, player1).get(0).getName());
    }
	...
	public void checkPlayerNotLostTest() {
		...
		Player.currentPlayer = player1;
        assertTrue(PlayerVictoryManager.playersWhoLost(players, player1, player1).isEmpty());	}
	...
	public void isFortificationValidTest(){
        ...
        assertTrue(PlayerPhaseManager.isFortificationPhaseValid(mapIO, player1, player1));
    }
	...
	public void isFortificationValidFalse(){
		...
		country2.setPlayer(player1);
        assertFalse(PlayerPhaseManager.isFortificationPhaseValid(mapIO, player1, player1));
    }
	...
	public void exchangeCardsTest(){
		...
		CardManager.exchangeCards(player3, listOfCards,1, player3);
		assertEquals(5,player3.getArmyCount());
	}
	...
	public void automaticAssignPlayerArmiesToCountryTest() {
        ...
        PlayerPhaseManager.automaticAssignPlayerArmiesToCountry(player1, player1);
