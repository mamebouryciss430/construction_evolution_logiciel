...
public class DescCountryTest {
    ...
    public void setUp() throws Exception {
        ...
        countryList.add(new CountryModel("London",0,0,"Asia",null,3,"Bill"));
    ...
    /**
     * Test descending country
     */
    @Test
    @Disabled("Avoid slow graphical tests")
    public void testDescendingCountry()
    {
        cardList= gamePlayModel.descCountry(countryList);
        Assert.assertEquals(cardList.get(0).getCountryName(),"China");
