...
public class Player implements Observer, Transaction, org.atlanmod.risk.core.Player {
	...
	public Player(String s, long id, int n) {
		this.playerName = s;
		this.user_id = id;
		this.numOfTroops = n;
	...
	@Override
	public int buyCards() {
		System.out.print("Remaining Credit After Buy a riskboardgame.Card : ");
