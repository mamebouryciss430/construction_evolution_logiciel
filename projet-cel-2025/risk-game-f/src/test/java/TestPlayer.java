...
public class TestPlayer extends TestCase {
	Player test = new Player("Vivian", 12345,40);
    ...
    {
    	assertEquals("Vivian", test.getName());
    }
    @Test
    ...
    public void testSetupPlayer()
    {
    	...
    	assertEquals("Vincent", test.getName());
    }
	@Test
	...
	@Test
	public void testBuyccc()
	{
		assertEquals(20, test.buyccc());
	}
	@Test
	public void testSetUserId()
	{
		test.setUserID(12345);
		assertEquals(12345, test.getUserId());
	}
	@Test
