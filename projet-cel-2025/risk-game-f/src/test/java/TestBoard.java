...
public class TestBoard {
	...
	Setup setup = new Setup();
	  ...
	  public void testShowCountryValidation()
	  {
		  ...
		  assertEquals("Invalid riskboardgame.Country Name", bd.showCountryValidation("test1", "test", 1));
	  ...
	  public void failingTest() {
		  Board bd = new Board(setup.LoadMap(), setup.LoadDeck());
		  bd.testGenerator();
		  String actual = bd.checkCategory("test1", 12345, "/help");

		  assertEquals(351, actual.length());
	  }
