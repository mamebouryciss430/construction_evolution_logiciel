...
public class MapController {
    ...
    public static final String BORDER_SUCCESS = "-fx-border-color: #00ff00; -fx-border-width: 3";
    ...
    @FXML private AnchorPane countryPercentagePane;
    ...
    public void init(Model model, Map map, MenuController menuController, CardView card, CardController cardController) {
        ...
        PlayersWorldDominationView.getInstance().init(countryPercentagePane, countryPercentageListView, armyDistributionListView, continentNameListView, model, countryChart);
    }
    ...
    private void addEventListener() {
        ...
        allOutEnableButton.setOnMouseClicked((e) -> {
            ...
            clearDefenderDiceButtons();
            displayDices(false);
            allOutEnableButton.setStyle(BORDER_SUCCESS);
    ...
    void initPhaseView() {
        ...
        GeneralComponents gc = new GeneralComponents(this);
        gc.addPhaseComponents(phaseLabel, nextPhaseButton)
          ...
          .addFortificationComponents(numArmiesMovedLabel, numArmiesMovedTextField, skipFortificationPhaseButton)
          .addSaveLoadButtons(saveGameButton, loadButton, invalidMovedLabel);
        phaseView.init(gc);
    ...
    private void setFromCountryInfo(Country country) {
        ...
        countryANameLabel.setStyle(BORDER_SUCCESS);
        }
    }
    ...
    private void resetFromToCountries() {
        ...
        countryANameLabel.setStyle(style);
        countryBNameLabel.setText("NONE");
        countryBNameLabel.setStyle(style);
    }
    ...
    private void resetAllDices() {
        ...
        allOutDisableButton.setStyle(BORDER_SUCCESS);
        displayDices(true);
