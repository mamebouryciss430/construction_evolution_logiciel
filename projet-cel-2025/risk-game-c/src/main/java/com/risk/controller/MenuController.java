...
public class MenuController {
    ...
    @FXML
    public ListView<String> selectedMapsListView;
    ...
    public void loadGame() throws IOException,ClassNotFoundException {
        ...
        if (null != savedGameFile) {
            ...
            PlayersWorldDomination.getInstance().setTotalNumCountries(model.mapModel.getCountries().size());
            ...
            mapController.setNumOfCountries(model.mapModel.getCountries().size());
     ...
     */
    public void validateEnteredNumPlayer(String enteredPlayerNum) {
        if (!tournamentMode) {
            playerTypes.clear();
