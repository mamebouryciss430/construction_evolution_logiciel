...
public class ViewController {
    ...
    public void initialize(View view) {
        Image iconDown=new Image(getClass().getClassLoader().getResourceAsStream("down-icon.png"));
        btnAddContinent.setGraphic(new ImageView(iconDown));

        Image iconDelete=new Image(getClass().getClassLoader().getResourceAsStream("delete-icon.png"));
        btnDelContinent.setGraphic(new ImageView(iconDelete));
        ...
        drawPane.setOnMouseClicked(drawPaneClicked);
        countryList=new ArrayList<>();
        attachDrawPaneListener(drawPane);
    ...
    public void drawCountry(Country country, boolean isUserClick) {
        ...
        drawPane.getChildren().add(country);
    ...
    /**
     * Set on event listeners for drawPane object
     * @param drawPane Draw_pane object
     */
    private void attachDrawPaneListener(AnchorPane drawPane){
        addMouseDragged(drawPane);
        addMouseMoved(drawPane);
        addMouseReleased(drawPane);
    }
    ...
    /**
     * Set on event listener when mouse moves over the drawPane
     * @param drawPane Draw pane object
     */
    private void addMouseMoved(AnchorPane drawPane) {
    ...
    /**
     * Set on event listener when mouse drags over the drawPane
     * @param drawPane Draw pane object
     */
    private void addMouseDragged(AnchorPane drawPane) {
    ...
    /**
     * Set on event listener when mouse released on the drawPane
     * @param drawPane Draw pane object
     */
    private void addMouseReleased(AnchorPane drawPane) {
        drawPane.setOnMouseReleased(event -> {
            if (!dragActive) return;
            Optional<Country> countryTmp=findCountry(event.getSceneX(),event.getSceneY());
            if (countryTmp.isPresent()){
                stopDrag(countryTmp.get());
            }else{
                stopDrag();
            }
            event.consume();
    ...
    private void addMouseOver(Edge line) {
        line.setOnMouseEntered(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                line.setStrokeWidth(Edge.DELETE_WIDTH);
                event.consume();
            }
        });
    }
    ...
    private void addMouseExit(Edge line) {
        line.setOnMouseExited(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                line.setStrokeWidth(Edge.NORMAL_WIDTH);
                event.consume();
            }
        });
    }
    ...
    public void save() {
        ...
        File file = fileChooser.showSaveDialog(viewPane.getScene().getWindow());
